---
title: AWS Lambda@Edge에서 최적화된 이미지 전달받기 위한 인프라 구성
slug: image-optimization-via-lambda-edge
date: 2022-01-21
description: AWS Lambda@Edge에서 온디멘드 이미지 리사이징과 WebP 형식 변환을 통해 최적화된 이미지를 전달받기 위한 인프라를 구성해보고 기록합니다.
tags:
  - AWS
  - Lambda@Edge
  - WebP
...
![opportunity-1](./images/intro1.png)
![opportunity-2](./images/intro2.png)
...
![connect-policy](./images/connect-policy.png)
...
![set-policy](./images/set-policy.png)
...
![upload-code](./images/upload-code.png)
...
![distribution-lambda](./images/distribution-lambda.png)
