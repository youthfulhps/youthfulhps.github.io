---
title: Openapi-generator를 통한 타입세이프한 개발, 그리고 Mock 서버까지
slug: how-to-use-openapi-generator
date: 2021-07-28
description: 실무에서 Openapi-generator와 Stoplight를 통해 API 스펙을 공유한 경험을 정리합니다.
tags:
  - openapi-generator
banner: ./images/intro1.png
---
...
![output](./images/openapi-output.png)
