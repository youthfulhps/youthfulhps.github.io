...
const CarbonThemeStyle = ({ style }) => {
  return (Object(_index_1cc0b8cf_js__WEBPACK_IMPORTED_MODULE_0__["h"])("style", null, `
      :host ${style};
    `));
};
...
const HighlightCode = class {
  constructor(hostRef) {
    Object(_index_1cc0b8cf_js__WEBPACK_IMPORTED_MODULE_0__["r"])(this, hostRef);
    this.prismLanguageLoaded = Object(_index_1cc0b8cf_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "prismLanguageLoaded", 7);
    this.prismLanguageError = Object(_index_1cc0b8cf_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "prismLanguageError", 7);
    /**
  ...
  render() {
    ...
    return (Object(_index_1cc0b8cf_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_index_1cc0b8cf_js__WEBPACK_IMPORTED_MODULE_0__["H"], { class: hostClass }, this.renderCarbon(), this.renderUbuntu(), this.renderHighlightStyle(), Object(_index_1cc0b8cf_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "container", ref: (el) => (this.refContainer = el) }, Object(_index_1cc0b8cf_js__WEBPACK_IMPORTED_MODULE_0__["h"])("code", { class: ((_a = this.highlightLines) === null || _a === void 0 ? void 0 : _a.length) > 0 ? 'highlight' : undefined, ref: (el) => (this.refCode = el) }), Object(_index_1cc0b8cf_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: "code" }), this.editable && Object(_index_1cc0b8cf_js__WEBPACK_IMPORTED_MODULE_0__["h"])("deckgo-highlight-code-edit", { label: this.editableLabel }))));
  }
  renderHighlightStyle() {
    if (!this.highlightLines || this.highlightLines.length <= 0) {
      return undefined;
    }
    return Object(_index_1cc0b8cf_js__WEBPACK_IMPORTED_MODULE_0__["h"])(HighlightStyle, Object.assign({}, this.highlightRows));
  }
  renderCarbon() {
    if (this.terminal !== _languages_1293bacc_js__WEBPACK_IMPORTED_MODULE_1__["D"].CARBON) {
      return undefined;
    ...
    return [
      Object(_index_1cc0b8cf_js__WEBPACK_IMPORTED_MODULE_0__["h"])(CarbonThemeStyle, { style: this.themeStyle }),
      Object(_index_1cc0b8cf_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "carbon" }, this.renderCarbonCircle('red'), this.renderCarbonCircle('yellow'), this.renderCarbonCircle('green'))
    ];
  }
  renderCarbonCircle(color) {
    return Object(_index_1cc0b8cf_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: color });
  }
  renderUbuntu() {
    if (this.terminal !== _languages_1293bacc_js__WEBPACK_IMPORTED_MODULE_1__["D"].UBUNTU) {
      return undefined;
    }
    return (Object(_index_1cc0b8cf_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "ubuntu" }, this.renderUbuntuCircle('close'), this.renderUbuntuCircle('minimize'), this.renderUbuntuCircle('maximize'), Object(_index_1cc0b8cf_js__WEBPACK_IMPORTED_MODULE_0__["h"])("p", null, Object(_index_1cc0b8cf_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: "user" }))));
  }
  renderUbuntuCircle(mode) {
    const symbol = mode === 'close' ? '&#10005;' : mode === 'minimize' ? '&#9472;' : '&#9723;';
    return (Object(_index_1cc0b8cf_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: mode }, Object(_index_1cc0b8cf_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { innerHTML: symbol })));
  }
  get el() { return Object(_index_1cc0b8cf_js__WEBPACK_IMPORTED_MODULE_0__["g"])(this); }
...
const Edit = class {
  constructor(hostRef) {
    Object(_index_1cc0b8cf_js__WEBPACK_IMPORTED_MODULE_0__["r"])(this, hostRef);
    this.editCode = Object(_index_1cc0b8cf_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "editCode", 7);
  }
  render() {
    return (Object(_index_1cc0b8cf_js__WEBPACK_IMPORTED_MODULE_0__["h"])("button", { onClick: () => this.editCode.emit(), "aria-label": this.label || 'Edit code', part: "edit-button" }, Object(_index_1cc0b8cf_js__WEBPACK_IMPORTED_MODULE_0__["h"])("svg", { xmlns: "http://www.w3.org/2000/svg", height: "24px", viewBox: "0 0 24 24", width: "24px", fill: "currentColor", part: "edit-icon" }, Object(_index_1cc0b8cf_js__WEBPACK_IMPORTED_MODULE_0__["h"])("path", { d: "M0 0h24v24H0z", fill: "none" }), Object(_index_1cc0b8cf_js__WEBPACK_IMPORTED_MODULE_0__["h"])("path", { d: "M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z" }))));
  }
};
Edit.style = editCss;
